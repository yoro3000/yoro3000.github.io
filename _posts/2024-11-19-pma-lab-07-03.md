...
The thing that we need to understand right now is whats found at "dword_403010" - Based on my comments we can see that it is "kerne132.dll" but let's see how I found this value.\
When we double click the dword we can see those values:\
